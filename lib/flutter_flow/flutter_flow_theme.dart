...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF081F5C);
  late Color secondary = const Color(0xFF7096D1);
  late Color tertiary = const Color(0xFFD0E3FF);
  late Color alternate = const Color(0xFFF2F0DE);
  late Color primaryText = const Color(0xFF12151C);
  late Color secondaryText = const Color(0xFF5A5C60);
  late Color primaryBackground = const Color(0xFFEDF1F6);
  late Color secondaryBackground = const Color(0xFFFFF9F0);
  late Color accent1 = const Color(0xFFBAD6EB);
  late Color accent2 = const Color(0x4C8AC7FF);
  late Color accent3 = const Color(0xFFF7F2EB);
  ...
  late Color customColor1 = const Color(0xFF334EAC);
  late Color customColor2 = const Color(0xFF5FD4E5);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color customColor1 = const Color(0xFF061097);
  late Color customColor2 = const Color(0xFF5FD4E5);
}
